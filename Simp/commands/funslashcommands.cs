...
namespace Simp.commands
{
    ...
    {
        private static readonly string[] options = ["You look okay today! OwO", "you want some fuck?", "OwO could you like be mine OwO", "great job today!", "you look adorable!", "can i like pay all your bills", "i would tier 3 sub for u"];
