...
namespace Server_Servant
{
    class Program
    {
        ...
        static async Task MainAsync()
        {
            ...
            discord.GuildAvailable += ClientGuildAvailable;//add guilds avilable event
        ...
        private static Task ClientGuildAvailable(DiscordClient client, GuildCreateEventArgs e)
        {
